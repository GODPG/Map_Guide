...
private:
    ...
    void initScene();
    void bindButtonsByObjectName();
    void updateUiStateHint();
    ...
    void showStreetViewDialog(int nodeId);
    ...
    void clearProjectVisualAndData();
